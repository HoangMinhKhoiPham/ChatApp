...
extension ChatMessage {
    ...
    static func fromSnapshot(snapshot: QueryDocumentSnapshot) -> ChatMessage? {
        ...
        return ChatMessage(documentId: snapshot.documentID, text: text, uid: uuid, dateCreated: dateCreated, displayName: displayName, profilePhotoURL: profilePhotoURL, attachmentPhotoURL: attachmentPhotoURL)
    }
}
